...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-20 px-4 md:px-6 bg-gradient-to-b from-white to-gray-100 dark:from-analyst-darkgrey dark:to-analyst-black">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4 text-gray-800 dark:text-white">Skills Overview</h2>
          ...
          {[
            ...
            <div key={index} className="space-y-1.5">
              <div className="flex justify-between">
                ...
                <span className="text-sm text-gray-600 dark:text-white/80">{skill.level}%</span>
              </div>
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-semibold mb-8 text-center text-gray-800 dark:text-white">Domain Expertise</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {domainExpertise.map((domain, index) => (
              <Card key={index} className="hover-lift border border-gray-200 bg-white shadow-md dark:bg-gradient-to-br dark:from-analyst-darkgrey dark:to-analyst-black dark:border-analyst-blue/20">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-xl font-medium mb-2 text-gray-800 dark:text-white">{domain.title}</h4>
                      <p className="text-gray-600 dark:text-white/80 mb-4">{domain.description}</p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {domain.areas.map((area, i) => (
                          <HoverCard key={i}>
                            ...
                            <HoverCardContent className="w-64 bg-white shadow-md border-gray-200 dark:bg-analyst-darkgrey dark:text-white">
                              <p className="text-sm text-gray-600 dark:text-white/90">Specialized expertise in {area} techniques and applications.</p>
                            </HoverCardContent>
                          </HoverCard>
                        ))}
                      </div>
